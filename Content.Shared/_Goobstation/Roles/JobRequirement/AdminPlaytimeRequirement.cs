...
namespace Content.Shared._Goobstation.Roles;

[UsedImplicitly]
[Serializable, NetSerializable]
public sealed partial class AdminPlaytimeRequirement : JobRequirement
{
        ...
        [NotNullWhen(false)] out FormattedMessage? reason)
    {
        ...
        var overallTime = playTimes.GetValueOrDefault(PlayTimeTrackingShared.TrackerAdmin);
